...
function enviarMensagemTelegram($mensagem, $email) {
    ...
    $telegramBotToken = '7801985292:AAH7p8177cj2FUo3K2o3cvDESi4HhsBg1Xw'; 
    $telegramChatID = '1167792030';
...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'rifaondex@gmail.com'; // SEU EMAIL AQUI VEI PELA MOR DE DEUS 
    $mail->Password = 'gugaboy007'; // SENHA DO SEU EMAIL MANO
    $mail->SMTPSecure = 'tls';
